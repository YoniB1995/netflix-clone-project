...
function Register() {
  const loader = (
    <img src="./images/loaderImg.gif" alt="loaderimg" height="150px" />
  );
  const style = {
    color: "white",
    background:
      "linear-gradient(270deg, rgba(22,22,22,1) 23%, rgba(226,18,18,0.9444152661064426) 48%)",
    width: "70%",
    maxWidth: "300px",
    padding: "20px",
  ...
  return (
    <PageBody>
      ...
      <Form style={useStyle}>
        ...
        <Button type="submit" onClick={() => setShowPage(true)}>
          Submit
        </Button>
      </Form>
    </PageBody>
